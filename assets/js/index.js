...
$(document).ready(function () {
  ...
  populate_people_html('talk-content2', talk_content.slice(5,10 ))
  populate_people_html('talk-content3', talk_content.slice(10,11 ))
  // organizers content
  ...
  $('body').append(`
    ...
    <div class="container">
      <div class="content has-text-centered">
        ...
        <br>
        <p> <span id="last-updated"></span> Page template borrowed from <a target="_blank" href="https://NeuRL-RMW.github.io/"><span
